...
label1 = Label(root, text ='Your Password ')               
label1.grid(row = 10, column = 1)
label2 = Label(root, text ='Secret key')
label2.grid(row = 11, column = 1)
l3 = Label(root, text ="Secret Key")
l3.grid(row = 10, column = 10)
l4 = Label(root, text ="Your Decrypted Password")
